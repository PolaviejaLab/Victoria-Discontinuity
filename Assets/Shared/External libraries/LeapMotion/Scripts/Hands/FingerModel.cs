...
public abstract class FingerModel :MonoBehaviour
{
	...
	/**
	 * Returns any additional movement the finger needs 
	 * because of non-relative palm movement.
	 */
	...
	/**
	 * Returns the location of the tip of the finger in
	...
	/**
	 * Returns the location of the given joint on the 
	 * finger in relation to the controller.
	 */
	...
	/**
	 * Returns a ray from the tip of the finger in the 
	...
	/**
	 * Returns the direction the given bone is facing on the
	 * finger in relation to the controller.
	 */
	...
	/**
	 * Returns the rotation quaternion of the given bone in 
	 * relation to the controller.
	 */
